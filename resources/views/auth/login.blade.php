    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-brand {
            ...
            padding: 52px 56px;
            background:
                radial-gradient(ellipse at 15% 85%, rgba(168,85,247,0.35) 0%, transparent 50%),
                radial-gradient(ellipse at 85% 10%, rgba(99,102,241,0.25) 0%, transparent 48%),
        ...
        /* Background glow behind the form */
        .auth-panel::before {
            content: '';
            position: absolute;
            top: 30%;
        ...
        <div class="auth-features">
            <div class="auth-feature">
                <div class="auth-feature-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M8 1.5L2 4v4c0 3 2.7 5.5 6 7 3.3-1.5 6-4 6-7V4L8 1.5z"/></svg>
                </div>
                <div class="auth-feature-text">
                    <strong>Authentification sécurisée</strong>
                    <span>Connexion via compte Google professionnel uniquement</span>
                </div>
            </div>
            <div class="auth-feature">
                <div class="auth-feature-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><line x1="2" y1="4" x2="14" y2="4"/><line x1="2" y1="8" x2="14" y2="8"/><line x1="2" y1="12" x2="10" y2="12"/></svg>
                </div>
                <div class="auth-feature-text">
                    <strong>Journalisation complète</strong>
                    <span>Toutes les actions enregistrées en temps réel</span>
                </div>
            </div>
            <div class="auth-feature">
                <div class="auth-feature-icon">
                ...
                <div class="auth-feature-text">
                    <strong>Accès par rôles</strong>
                    <span>Permissions granulaires par technicien</span>
                </div>
            </div>
        </div>
    </div>
